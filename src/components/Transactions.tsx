...
const Transactions: React.FC = () => {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', bgcolor: COLORS.background.main }}>
      <Container maxWidth={false} disableGutters sx={{ mt: { xs: 0, md: 4 }, mb: 4, flexGrow: 1, px: { xs: 1.5, sm: 2, md: 4 } }}>
      ...
      <Dialog
        ...
        maxWidth="md"
        fullWidth
        PaperProps={{ sx: { boxShadow: 'none', borderRadius: { xs: 0, sm: 4 }, m: { xs: 0, sm: 2 }, maxHeight: { xs: '100%', sm: '90vh' }, height: { xs: '100dvh', sm: 'auto' } } }}
      >
      ...
      <Paper sx={{ p: { xs: 2, sm: 3 }, borderRadius: 2 }} elevation={2}>
        <Box display="flex" alignItems="center" justifyContent="space-between" mb={1}>
          ...
          <Button variant="contained" startIcon={<Add />} onClick={handleOpen} size="small"
            sx={{ background: 'linear-gradient(135deg, #43e97b 0%, #28C76F 100%)', boxShadow: '0 4px 12px rgba(40,199,111,0.3)', '&:hover': { boxShadow: '0 6px 16px rgba(40,199,111,0.4)', transform: 'translateY(-1px)' }, transition: 'all 0.2s ease', whiteSpace: 'nowrap' }}>
            ...
            <Table size="medium" sx={{ minWidth: 480 }}>
              <TableHead>
                <TableRow sx={{ bgcolor: 'action.hover' }}>
                  ...
                  <TableCell sx={{ fontWeight: 600, cursor: 'pointer', userSelect: 'none', display: { xs: 'none', sm: 'table-cell' } }} onClick={() => handleSort('type')}>
                    Type <SortIcon col="type" />
                  </TableCell>
                  <TableCell sx={{ fontWeight: 600, cursor: 'pointer', userSelect: 'none', display: { xs: 'none', md: 'table-cell' } }} onClick={() => handleSort('currency')}>
                    Resource <SortIcon col="currency" />
                  </TableCell>
                  <TableCell sx={{ fontWeight: 600, display: { xs: 'none', md: 'table-cell' } }}>Description</TableCell>
